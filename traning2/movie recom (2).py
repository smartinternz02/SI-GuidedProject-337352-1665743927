...
def predict():
    ...
    if(emotion == "happy"):
        ...
        urlhere = 'https://www.imdb.com/search/title/?genres=horror&explore=title_type,genres&title_type=movie. asc'
    elif(emotion == "comedy"):
        urlhere = "https://m.imdb.com/search/title/?genres=comedy&explore=title_type,genres&title_type=movie, asc" 
